...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular 'email adicional', 'emails adicionais'
  inflect.irregular 'email_adicional', 'emails_adicionais'  
  inflect.irregular 'modelo_template', 'modelos_templates'
